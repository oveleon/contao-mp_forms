...
$GLOBALS['TL_DCA']['tl_form_field']['palettes']['__selector__'][] = 'mp_forms_forceCondition';
$GLOBALS['TL_DCA']['tl_form_field']['palettes']['mp_form_pageswitch'] = '{type_legend},type,label,mp_forms_backButton,slabel;{image_legend:hide},imageSubmit;{condition_legend},mp_forms_forceCondition;{expert_legend:hide},mp_forms_backFragment,mp_forms_nextFragment,class,accesskey,tabindex;{template_legend:hide},customTpl;{invisible_legend:hide},invisible';
...
$GLOBALS['TL_DCA']['tl_form_field']['subpalettes']['mp_forms_forceCondition'] = 'mp_forms_condition';
...
$GLOBALS['TL_DCA']['tl_form_field']['fields']['mp_forms_forceCondition'] = [
    'label'     => &$GLOBALS['TL_LANG']['tl_form_field']['mp_forms_forceCondition'],
    'exclude'   => true,
    'inputType' => 'checkbox',
...
$GLOBALS['TL_DCA']['tl_form_field']['fields']['mp_forms_condition'] = [
    'label'     => &$GLOBALS['TL_LANG']['tl_form_field']['mp_forms_condition'],
    'exclude'   => true,
    'inputType' => 'textarea',
